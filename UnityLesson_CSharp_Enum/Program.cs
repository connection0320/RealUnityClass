...
enum e_PlayerState // <<타입임
{
    ...
    Dash,    // ...00000101
    Home,    // ...00000110
    //DashAttack = Attack | Dash  // ...00000101  << Dash랑 똑같음 따라서
    DashAttack, // ...00000111
}
...
enum e_PlayerStateFlags
{
    ...
    Dash = 1 << 4,      //...00010000
    Home = 1 << 5,      //...00100000
    DasgAttack = Attack | Dash, // 00010001 /
...
namespace UnityLesson_CSharp_EnumAndSwitchCase
{
    internal class Program
    {
        ...
        static e_PlayerState createMotion = (e_PlayerState)3;
    ...
    public class Warrior
    {
        ...
        public void Attack()
        {
            Console.WriteLine($"{name}이가 공격함");
        }
        public void Jump()
        {
            Console.WriteLine($"{name}이가 점프함");
        }
        public void Walk()
        {
            Console.WriteLine($"{name}이가 걸음");
        }
        public void Run()
        {
            Console.WriteLine($"{name}이가 달림");
        }
        public void Dash()
        {
            Console.WriteLine($"{name}이가 돌진함");
        }
        public void Home()
        {
            Console.WriteLine($"{name}이가 귀환함");
        }
    }
}
