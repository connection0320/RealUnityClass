    ...
    internal class Program
    {
        static void Main(string[] args)
        {
           Creature creature = new Creature();
            ...
            Console.WriteLine($"age:{human.age},{human.height},{human.weight}");
            ...
            //Human 변수에 있는 Breath를 호출하면 WhiteMan 에 있는 Breath 가 호출됨
            //
            ...
            // 위 성질을 이용하여 부모클래스(Human) 리스트 하나만 생성
            ...
            //인터페이스 인스턴스화 예시
            ITwoLeggedWalker iTwoLeggedWalekr = new WhiteMan();
            iTwoLeggedWalekr.TwoLeggedWalk();
