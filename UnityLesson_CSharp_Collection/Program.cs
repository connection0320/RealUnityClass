...
namespace UnityLesson_CSharp_Collection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // foreach는 collection 이 가지고 있는 타입의 아이템만큼
            ...
            // dictionary 에서 Keys 를 가져오면 KeyCollection을 가져올 수 있고
            // dictionary 에서 Values 를 가져오면 VlauesCollection을 가져올 수 있다.
            // 즉, dictionary 자체도 , key , value 각각도 foreach 구문이 가능하다.

            // dictionary.Keys 를 foreach문 실행
